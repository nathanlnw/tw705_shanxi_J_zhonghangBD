...
u8		RemoteIP_main[4]={221,204,240,66};  //{221.204.240.66};山西中航北斗          
u16		RemotePort_main= 7000;//山西中航北斗   7000
u8		RemoteIP_aux[4]={60,28,50,210};    //{60,28,50,210}
u16		RemotePort_aux=4000; 
//           Link2  Related 
u8      Remote_Link2_IP[4]={221,204,240,66}; 
...
void  Vehicleinfo_Init(void) 
{
	...
	Vechicle_Info.Dev_ProvinceID=14;  // 默认省ID   0      13  河北省  14 : 山西省 
